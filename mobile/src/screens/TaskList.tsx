...
import { server, showError } from '../functions/common';
...
export default class TaskList extends Component<TaskListProps, State> {
    state = { ...initialState };
    ...
    loadTasks = async () => {
        try {
            ...
            const res = await axios.get<TaskItem[]>(`${server}/tasks?date=${maxDate}`);
    ...
    addTask = async (newTask: { desc: string; date: Date }) => {
